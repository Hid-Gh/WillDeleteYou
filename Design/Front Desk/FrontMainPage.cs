...
{
    public partial class FrontMainPage : Form
    {
        bool closed = true;
        ...
        private void MainPage_Load(object sender, EventArgs e)
        {
            ...
            Methods.SwitchForms<BookingPage>(MenusPnl.Controls[0] as Button, indicator, this, switchList, Color.Transparent);
        ...
        private void btnBook_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if(btn.Text == "Attendence")
                Methods.SwitchForms<AttendencePage>(btn , indicator, this, switchList, Color.Transparent);

            else
                Methods.SwitchForms<BookingPage>(btn, indicator, this, switchList, Color.Transparent);

        }

        private void FrontMainPage_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (closed)
                Application.Exit();
